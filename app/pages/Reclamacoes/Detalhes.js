...
import { getPetitionById, getRemainingTimeForPetition, getReportById, getUserById } from '../../utils/Api';
...
export default function VerReclamacaop({ navigation, route }) {
    ...
    const loadPetitionDetails = async () => {
        try {
            ...
            if (id) {
                ...
                const petitionDetails = await getReportById(id);

                if (petitionDetails.content) {
                    setPetition(petitionDetails.content);
    ...
    const handleApprove = async () => {
        await updateComplaintStatus(petition, 1, true, loadPetitionDetails);
    };
    ...
    const handleRevoke = async () => {
        await updateComplaintStatus(petition, 0, false, loadPetitionDetails);
    };
    ...
    const handleDelete = async () => {
        await deleteComplaintControl(petition, () => {
